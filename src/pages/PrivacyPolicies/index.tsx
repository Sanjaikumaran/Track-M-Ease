  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow">
        ...
        <p className="mb-8 text-sm text-gray-500">Last Updated: June 3, 2026</p>
        {/* Privacy Policy */}
        <section id="privacy-policy" className="mb-12">
          ...
          <h3 className="mb-2 text-lg font-medium">Information We Collect</h3>
          ...
          <h3 className="mb-2 text-lg font-medium">How We Use Information</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6 text-gray-700">
          ...
          <p className="text-gray-700">
            ...
            providers required to operate the platform or when legally required.
          </p>
        </section>
        ...
        <section id="data-deletion">
          ...
          <h3 className="mb-2 text-lg font-medium">How to Request Deletion</h3>
          ...
          <h3 className="mt-6 mb-2 text-lg font-medium">Processing Time</h3>
          <p className="text-gray-700">
